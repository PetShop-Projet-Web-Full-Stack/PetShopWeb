    ...
    <div className="bg-slate-100 w-2/5 xl:w-1/3 flex flex-col flex-grow gap-5 p-5 ">
      <div className="flex gap-3 justify-center">
        <img
          ...
          src="https://www.franchise-magazine.com/wp-content/uploads/Franchise-Animalerie-Tom-Co-Magasin-Facade.jpg"
          alt="Not found"
        />
      </div>
      ...
      <div className="font-bold grid grid-cols-2 gap-4">
        ...
        <textarea
          ...
          disabled={true}
          className="resize-none border h-60 p-2 rounded-lg col-span-2"
        />
      </div>
    </div>
  );
